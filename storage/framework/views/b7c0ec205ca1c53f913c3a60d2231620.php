            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $expertise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-primary-100 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-slate-900 mb-2"><?php echo e($item['title']); ?></h3>
                        <p class="text-slate-600 text-sm"><?php echo e($item['desc']); ?></p>
                    </div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <?php $__currentLoopData = $facts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center gap-3">
                                ...
                                <span class="text-slate-300"><?php echo e($fact); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\laravel_herd_projects\dimgent_by\resources\views/pages/about.blade.php ENDPATH**/ ?>