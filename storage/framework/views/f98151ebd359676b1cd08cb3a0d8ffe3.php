        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex items-center gap-2 text-slate-400 mt-3" x-data="obfuscatedPhone(['+375 ', '29 ', '636-', '35-', '97'])">
                        <svg class="w-5 h-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH D:\Projects\laravel_herd_projects\dimgent_by\resources\views/layouts/app.blade.php ENDPATH**/ ?>