                            ...
                            async submitForm() {
                                ...
                                if (Object.keys(this.errors).length === 0) {
                                    ...
                                    try {
                                        ...
                                        const response = await fetch('<?php echo e(route('contacts.submit')); ?>', {
                                            method: 'POST',
                                            headers: {
...
<?php $component = Spatie\Honeypot\View\HoneypotComponent::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                ...
                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
                        <button @click="openFaq = openFaq === <?php echo e($index); ?> ? null : <?php echo e($index); ?>"
                            ...
                            <span class="font-semibold text-slate-900"><?php echo e($faq['question']); ?></span>
                            <svg :class="openFaq === <?php echo e($index); ?> ? 'rotate-180' : ''" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\laravel_herd_projects\dimgent_by\resources\views/pages/contacts.blade.php ENDPATH**/ ?>