...
<?php $__env->startSection('meta_description', 'Custom electronic device development services - full cycle development from concept to finished product, or individual phases as required.'); ?>
<?php $__env->startSection('meta_keywords', 'developing electronic devices, designing circuit boards, developing hardware devices, software, developing customized electronic devices, electric circuits, developing circuit boards, programming microcontrollers'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $colors = $colorClasses[$service['color']]; ?>
                    <div class="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 
                                hover:border-<?php echo e($service['color']); ?>-100 transition-all duration-300 hover:-translate-y-1">
                        <div class="w-14 h-14 <?php echo e($colors['bg']); ?> rounded-xl flex items-center justify-center mb-6
                                    <?php echo e($colors['hover']); ?> group-hover:scale-110 transition-all duration-300">
                            <svg class="w-7 h-7 <?php echo e($colors['text']); ?> group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <?php echo $service['icon']; ?>

                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-slate-900 mb-3"><?php echo e($service['title']); ?></h3>
                        <p class="text-slate-600 leading-relaxed"><?php echo e($service['description']); ?></p>
                    </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <?php $__currentLoopData = $advantages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advantage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-primary-100 transition-all duration-300">
                        <div class="text-4xl mb-4"><?php echo e($advantage['icon']); ?></div>
                        <h3 class="text-lg font-bold text-slate-900 mb-2"><?php echo e($advantage['title']); ?></h3>
                        <p class="text-slate-600 text-sm leading-relaxed"><?php echo e($advantage['description']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\laravel_herd_projects\dimgent_by\resources\views/pages/services.blade.php ENDPATH**/ ?>