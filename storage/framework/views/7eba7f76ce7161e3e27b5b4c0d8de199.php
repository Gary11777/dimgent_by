...
<?php $__env->startSection('meta_description', 'Услуги по разработке электронных устройств на заказ - полный цикл разработки от концепта до готового изделия.'); ?>
<?php $__env->startSection('meta_keywords', 'разработка электронных устройств, разработка печатных плат, программное обеспечение, электрические схемы, программирование микроконтроллеров'); ?>
