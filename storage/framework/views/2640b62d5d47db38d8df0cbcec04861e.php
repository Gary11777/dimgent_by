...
<?php $__env->startSection('meta_description', 'Портфолио проектов по разработке электронных устройств: системы управления, измерительные приборы, медицинские устройства, бытовая техника.'); ?>
<?php $__env->startSection('meta_keywords', 'автоматические измерители, разработка электронных устройств, диммеры, радиоудлинители, беспроводные наушники, градиометры, электрозонды'); ?>
